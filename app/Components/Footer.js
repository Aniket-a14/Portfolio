    ...
    <>
      <div className="text-white flex justify-evenly min-h-[400px] pt-32">
        ...
        <nav className="flex flex-col gap-3">
          <span className="pb-2 text-white/70 text-base font-medium">SOCIALS</span>
          <div>
            <Link
            ...
            >
              <FaLinkedin className="text-xl group-hover:text-blue-600 transition-colors" />
              <span className="relative inline-block after:block after:w-0 after:h-[2px] after:bg-white after:transition-all after:duration-300 after:ease-in-out hover:after:w-full">
                LinkedIn
              </span>
            </Link>
          </div>
          <div>
            <Link
              ...
              className="group flex items-center gap-2 text-lg"
            >
              <FaGithub className="text-xl group-hover:text-gray-600 transition-colors" />
              <span className="relative inline-block after:block after:w-0 after:h-[2px] after:bg-white after:transition-all after:duration-300 after:ease-in-out hover:after:w-full">
                GitHub
              </span>
            </Link>
          ...
          <div>
            <Link
              ...
              className="group flex items-center gap-2 text-lg"
            >
              <FaInstagram className="text-xl group-hover:text-pink-600 transition-colors" />
              <span className="relative inline-block after:block after:w-0 after:h-[2px] after:bg-white after:transition-all after:duration-300 after:ease-in-out hover:after:w-full">
                Instagram
              </span>
            </Link>
          ...
          <div>
            <Link
              ...
              className="group flex items-center gap-2 text-lg"
            >
              <FaFacebook className="text-xl group-hover:text-blue-600 transition-colors" />
              <span className="relative inline-block after:block after:w-0 after:h-[2px] after:bg-white after:transition-all after:duration-300 after:ease-in-out hover:after:w-full">
                Facebook
              </span>
            </Link>
        ...
        <nav className="flex flex-col gap-3">
          <span className="pb-2 text-white/70 text-base font-medium">CODING PROFILES</span>
          <div>
            <Link
